// Сначала нужно выбрать с чем мы будем взаимодействовать: 1-списки, s-стек, q-очередь.
// Входные данные для списка и очереди: + c 4.2 -4 и - v 6 2.6 5 8 2 8 9 5
// Входные данные для стека: 5 4 + 2 - 4 ^ n или 8 3 * 2 + n
// В конце строк пишем "n".
